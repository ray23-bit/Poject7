...
// Effect style selection and auto-close panel
const effectStyleOptions = document.querySelectorAll('.effect-style-option');
const effectStylePanel = document.querySelector('.effect-style-container');

effectStyleOptions.forEach(option => {
    option.addEventListener('click', function () {
        effectStyleOptions.forEach(opt => opt.classList.remove('selected'));
        this.classList.add('selected');
